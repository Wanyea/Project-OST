...
public class PathfinderScript : MonoBehaviour
{
    ...
    void AvoidCollision() 
    {
        ...
        Debug.DrawRay(left, pathfinder.transform.forward * detectionDistance, Color.red);
        Debug.DrawRay(right, pathfinder.transform.forward * detectionDistance, Color.red);
        Debug.DrawRay(up, pathfinder.transform.forward * detectionDistance, Color.red);
        Debug.DrawRay(down, pathfinder.transform.forward * detectionDistance, Color.red);
