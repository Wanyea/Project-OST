...
public class PathfinderScript : MonoBehaviour
{
    ...
    void Start() 
    {
        ...
        //foreach(var x in m_tiles) Debug.Log(x.ToString());
    }
    ...
    void StorePathfinderPosition() {
       pathfinderPosition[this.pathfinderPositionIndex] = this.gameObject.transform.position;
       Debug.Log(this.pathfinderPosition[pathfinderPositionIndex]);
       this.pathfinderPositionIndex++;
    }

    void PathfinderFinished() {
            flag = 1;
            Debug.Log("PATHFINDER DONE!!");
            //Debug.Log(pathfinderPosition);
        }
}
